...
class Tg115Transfer(_PluginBase):
                        ...
                        'content': [
                            ...
                            },
                            {
                                ...
                                'content': [
                                    ...
                                    {'component': 'VSwitch', 'props': {
                                        'model': 'onlyonce', 'label': '立即运行一次（保存后自动触发）'
                                    }},
                                ]
                            },
                            {
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            ...
                                            'variant': 'tonal',
                                            'title': '📡 Telegram 来源',
                                            'text': '配置要监控的公开频道。公开频道无需Bot进频道，插件通过 t.me/s/ 页面抓取。'
                                        }
                                    }
                                ]
                            },
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            ...
                                            'variant': 'tonal',
                                            'title': '💾 115 网盘配置',
                                            'text': 'Cookie保存到插件配置中，请勿泄露。保存后可在「插件详情」页测试有效性。'
                                        }
                                    }
                                ]
                            },
        ...
        return [
                        ...
                        'content': [
                            {
                                ...
                                'props': {
                                    ...
                                    'title': '📥 今日发现',
                                    'text': str(stats.get("today_finds", 0))
                                }
                            }
                        ]
                    },
                        ...
                        'content': [
                            {
                                ...
                                'props': {
                                    ...
                                    'title': '❌ 转存失败',
                                    'text': str(stats.get("today_fail", 0))
                                }
                            }
                        ]
                    },
        ...
        ] + [
            {
                ...
                'props': {
                    ...
                    'variant': 'text',
                    'text': f"{r['channel']} | {r['short_url']} | {r['result']}"
                }
            }
            for r in records
        ]
    ...
    def _get_recent_records(self, limit: int = 10) -> List[Dict]:
        ...
        try:
            ...
            c = conn.cursor()
            c.execute(
                """SELECT channel, share_url, status, result, created_at
    ...
    def monitor_channels(self):
        ...
        for ch in channels:
            if processed >= self._max_items:
                logger.info(f"【115转存助手】已达单次最大处理数 ({self._max_items})，停止本轮扫描")
                break
            ...
            for msg in new_msgs:
                ...
                logger.info(f"【115转存助手】[{processed}/{self._max_items}] 发现: {share_url}")
